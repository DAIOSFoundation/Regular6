                ...
                <Scene key='root' hideNavBar>
                    <Scene key='tabBar' tabs={true} showLabel={false}>
                        ...
                        <Scene key='Reservation' title='Reservation'
                            ...
                            <Scene key='reservationDetailScreen' component={ReservationDetailScreen} title='예약하기' backTitle=" "
                                   headerTintColor="#000"
                                   hideTabBar={true}/>
                            <Scene key='reservationConfirmScreen' component={ReservationConfirmScreen} title='예약확인' backTitle=" "
                                   headerTintColor="#000"
                                   hideTabBar={true}/>
                            <Scene key='reservationCompleteScreen' component={ReservationCompleteScreen} title='예약완료' backTitle=" "
                                   headerTintColor="#000"
                            />
                        </Scene>
